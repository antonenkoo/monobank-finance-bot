...
_CHANGELOG: dict[str, str] = {
    ...
    "v1.5.2": (
        ...
        "───────────────────────\n\n"
        "🐛 <b>Исправления</b>\n\n"
        "📡 <b>Транзакции не приходили</b>\n"
        "v1.5.1 сломал ngrok-туннель у monobank-бота — webhook у Monobank не регистрировался и транзакции не доходили. Исправлено\n\n"
        "⚡️ <b>/trigger не работал</b>\n"
        "Быстрый запуск шаблонов через внешний URL перестал отвечать. Исправлено\n\n"
        "⚙️ <b>NGROK_DOMAIN в настройках</b>\n"
        "Статический ngrok-домен теперь можно задать прямо через /config — без редактирования .env вручную"
    ),
    "v1.5.1": (
